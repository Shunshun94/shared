...
io.github.shunshun94.trpg.logEditor.menu.saveMenu.generateDom = (target) => {
	...
	>
        ...
        <button class="${io.github.shunshun94.trpg.logEditor.CLASSES.SAVE_MENU_WINDOW}-save" value="${target} css"
        ...
        <span><button class="${io.github.shunshun94.trpg.logEditor.CLASSES.SAVE_MENU_WINDOW}-save" value="${target} ytchat"
