...
キャラクターシートがそのキーに該当する値を持っているかつキーが lv （技能のレベル）で始まる場合に関数を実行し、
そのキャラクターの冒険者レベルに比してその技能が十分に高いレベルである場合に合格する。

十分に高い、の判断基準は以下の通りである。

* 冒険者レベルが2以下の場合、1レベルで技能を取得している
* 冒険者レベルが10以下の場合、冒険者レベル -2 以上のレベルで技能を取得している
* 冒険者レベルが11以上の場合、冒険者レベル -3 以上のレベルで技能を取得している

以下の例の場合、スカウト技能について十分なレベルで習得している場合に合格する。
```json
