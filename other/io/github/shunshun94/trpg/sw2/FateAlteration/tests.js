const tests = [
    {
        ...
        boost: 0,
        expected: `k30[13]h+10$10#+0r0`,
        note: '半減ダメージの変転（回転なし）'
    }, {
        input: `KeyNo.30c[9]+9 ＞ 2D:[4,6 6,5 6,5 6,5 3,3]=10,11,11,11,6 ＞ (10,10,10,10,6+9)/2+5 ＞ 4回転 ＞ 33`,
        boost: 0,
        expected: `k30[9]h+30$8#+0r0`,
        note: '半減ダメージの変転（回転あり）'
    }, {
        input: 'KeyNo.45c[10]m[+2]+12 ＞ 2D:[4,1]=7 ＞ 10+12 ＞ 22',
        boost: 0,
        expected: 'k45[10]+12$11#+0r0',
        note: 'クリティカルレイが絡んだ場合'
    }, {
        input: 'KeyNo.45c[10]m[+2]+12 ＞ 2D:[4,1]=7 ＞ 10+12 ＞ 22',
        boost: 1,
        expected: 'k45[10]+12$12#+0r0',
        note: 'クリティカルレイが絡み、ブーストがある場合'
    }, {
        input: 'KeyNo.20c[8]m[+2]+10 ＞ 2D:[1,6 4,4 4,1]=9,8,5 ＞ 7,6,3+10 ＞ 2回転 ＞ 26',
        boost: 0,
        expected: 'k20[8]+23$9#+0r0',
        note: 'クリティカルレイが絡むがクリティカル後は無効'
    }
];
