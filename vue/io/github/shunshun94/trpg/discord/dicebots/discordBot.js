...
Discord Bot の Token: <input type="text" @change="$emit('dicebot-discord-update-token', $event.target.value)" v-bind:value="discord_bot.token" /><br/>
...
Bot を起動する: <button @click="$emit('dicebot-discord-create-bot')">起動</button></div>`
});
